  ...
  return (
    ...
    <section className="bg-black text-white font-sans flex flex-col items-center w-full">
        ...
        <div className='flex justify-center items-center mt-[20px] sm:mt-[40px] w-[60%] sm:w-[40%] md:w-[50%] h-[250px] sm:h-[250px] md:h-[300px]' style={{backgroundImage:`url(${backgroundHeading})`, backgroundSize:'contain', backgroundRepeat:'no-repeat', backgroundPosition:"center"}}>
          <h1 className='font-fogLighten text-5xl text-glow text-white sm:text-8xl md:text-8xl'>VesHack</h1>
        </div>
      ...
      <p className="mt-20 text-sm md:text-lg text-gray-300 mx-auto">
        Get ready for an exciting coding adventure at Ves-Hack – The Ultimate Hackathon, happening as part of Vespera'24 in collaboration with IoSC 
        and AWS Cloud Club at GGSIPU EDC. This high-energy, 24-hour event invites tech enthusiasts from all backgrounds 
        to tackle problem statements across domains like AI, ML, Cloud, IoT, and more. With the backing of AWSCC and IoSC, Ves-Hack fosters a vibrant, 
        innovation-driven atmosphere where cutting-edge solutions come to life. Showcase your coding skills, collaborate with fellow developers, and 
        stand a chance to win amazing prizes. Open to everyone from coding beginners to experienced pros, it’s an opportunity to solve real-world challenges, 
        network with industry experts, and have an unforgettable experience. Get ready to dive into the world of tech at Ves-Hack, where creativity meets 
      ...
      <ul className="mt-[30px] space-y-4">
          <li className="bg-gray-800 p-4 rounded-lg lg:w-[600px] md:w-[500px] w-[300px]" style={{backgroundColor:'rgba(45, 45, 45, 1)', color:'white'}}><span className='font-bold'>Registration Starts</span><br></br> Oct 10th, 08:00 AM</li>
          <li className="bg-gray-800 p-4 rounded-lg" style={{backgroundColor:'rgba(45, 45, 45, 1)', color:'white'}}><span className='font-bold'>Round 1 starts</span><br></br> Oct 10th, 10:00 AM</li>
          <li className="bg-gray-800 p-4 rounded-lg" style={{backgroundColor:'rgba(45, 45, 45, 1)', color:'white'}}><span className='font-bold'>Round 1 Submission deadline</span><br></br> Oct 20th, 10:00 PM</li>
          ...
          <li className="bg-gray-800 p-4 rounded-lg" style={{backgroundColor:'rgba(45, 45, 45, 1)', color:'white'}}><span className='font-bold'>Final Round</span><br></br> Oct 25th, 10:00 AM</li>
        </ul>
      </div>
      <Faq/>
    </section>
